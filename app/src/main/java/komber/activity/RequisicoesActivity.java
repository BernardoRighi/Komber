...
import komber.R;
import komber.adapter.RequisicoesAdapter;
import komber.config.ConfiguracaoFirebase;
import komber.helper.RecyclerItemClickListener;
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                if (!latitude.isEmpty() && !longitude.isEmpty()){
                    ...
                    //Não receber as localizações do usuario neste momento, pois não é necessário
